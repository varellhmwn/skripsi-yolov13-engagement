"""
hog_features.py — Preprocessing dan Ekstraksi Fitur HOG (Group-Wise)
====================================================================
Utilitas terstandarisasi untuk ekstraksi fitur HOG pada dataset group-wise v1.
"""
...
from experiments_groupwise.config import (
    ...
    HOG_CELLS_PER_BLOCK, HOG_BLOCK_NORM, GROUPWISE_DATASET_DIR,
...
def load_dataset_split(split_name, use_largest_bbox=True):
    images_dir = GROUPWISE_DATASET_DIR / 'images' / split_name
    labels_dir = GROUPWISE_DATASET_DIR / 'labels' / split_name
